...
static NSString *cellID = @"FDNewCalendarCell";
...
- (void)setupCollectionView {
    ...
    [self.collectionView registerNib:[UINib nibWithNibName:@"FDNewCalendarCell" bundle:nil] forCellWithReuseIdentifier:cellID];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    FDNewCalendarCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:cellID forIndexPath:indexPath];
    ...
    if (indexPath.row < firstWeekday) {    // 小于这个月的第一天
        ...
        cell.dayLabel.textColor = [UIColor colorWithRed:200/255.0 green:200/255.0 blue:200/255.0 alpha:1];
        
        cell.chineseDayLabel.textColor = [UIColor colorWithRed:236/255.0 green:236/255.0 blue:236/255.0 alpha:1];
        ...
        if ((indexPath.item +1) % 7 ==0 || indexPath.item % 7 ==0) {
            cell.dayLabel.textColor = [UIColor colorWithRed:218/255.0 green:76/255.0 blue:92/255.0 alpha:1];
        }
        
        
        if (day == [[NSCalendar currentCalendar] component:NSCalendarUnitDay fromDate:self.date]) {
            cell.backgroundColor = [UIColor colorWithRed:218/255.0 green:76/255.0 blue:92/255.0 alpha:1];
