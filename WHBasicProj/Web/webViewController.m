    ...
    for(UIView *view in self.tabBarController.view.subviews)
    {
        ...
        {   //tabbar
            if (hidden) {
                ...
                [view setFrame:CGRectMake(0, DEVICEHEIGHT-49, DEVICEWIDTH, 49)];
            }
        }
        else
        {
            //view
            if (hidden) {
                [view setFrame:CGRectMake(0, 0, DEVICEWIDTH, DEVICEHEIGHT+49)];
            } else {
                [view setFrame:CGRectMake(0, 0, DEVICEWIDTH, DEVICEHEIGHT)];
            }
        }
    }
